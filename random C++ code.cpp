...
int main(){
    ...
    cout<< randomNumber<<randomWord<<randomSymbols<<secondrandomNumber + randomNumber; //for this your password will always be a random number between 0-100, a random word from the list i made, a random symbol, another random number from 0-100 + another random number between 0-100.
    return 0;
}